...
class InvoiceView: UIView {
    ...
    private func layoutView() {
        ...
        nameLabel.text = "이름 : \(parcelInformation.receiverName.value)"
        
        let mobileLabel: UILabel = UILabel()
        mobileLabel.textColor = .black
        mobileLabel.font = .preferredFont(forTextStyle: .largeTitle)
        mobileLabel.text = "전화 : \(parcelInformation.receiverMobile.value)"
        ...
        costLabel.text = "요금 : \(parcelInformation.discountedCost.value)"
